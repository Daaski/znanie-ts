...
export const MainEvents = forwardRef<HTMLButtonElement, MainEventsProps>(
    function MainEvents({ events }, eventsRef) {
        ...
        const onPaginationClick = (page: string) => {
            router
                ...
                .then();
            (
                eventsRef as MutableRefObject<HTMLButtonElement>
